---
name: security-study-matrix-styling
description: |
  Create security-focused study pages with attack/defense cards, risk levels, and structured layouts.
  Use when: (1) Building LLM security documentation, (2) Creating vulnerability study guides,
  (3) Documenting attack/defense patterns. Includes attack cards with severity levels,
  defense layers, mitigation cards, timeline components, and tool badges.
author: Claude Code
version: 1.0.0
date: 2026-02-23
---

# Security Study Matrix Styling

## Problem
Security documentation needs visual structure to differentiate attacks from defenses, show severity levels, and organize complex information.
